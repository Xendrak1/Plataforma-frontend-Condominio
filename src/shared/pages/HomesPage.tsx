// Gestión de viviendas (casas del condominio).
...
export function HomesPage() {
    ...
    const { term, setTerm, filteredData } = useTableFilter(data, ['codigo', 'categoria', 'ubicacion'])
	...
	const columns: TableColumn<Row>[] = [
		...
		{ header: 'Ubicación', accessor: r => r.ubicacion },
        ...
        <div style={{ padding: '2rem', maxWidth: '1200px', margin: '0 auto' }}>
            ...
            <div style={{ marginBottom: '2rem' }}>
                ...
                <p style={{ 
                    ...
                    Gestión de viviendas del condominio
                </p>
            </div>
            ...
            <div style={{ 
                ...
                <TableFilter placeholder="Buscar por código, categoría o ubicación" onChange={setTerm} />
            </div>
