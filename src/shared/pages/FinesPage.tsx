...
import { useFines } from '../../features/fines/hooks'
...
export function FinesPage() {
	...
	const { term, setTerm, filteredData } = useTableFilter(data, ['codigo', 'codigo_vivienda', 'persona_nombre', 'tipo_infraccion_descripcion', 'estado'])
	...
	const columns: TableColumn<Row>[] = [
		...
		{ header: 'Tipo', accessor: r => r.tipo_infraccion_descripcion },
		{ header: 'Fecha', accessor: r => r.fecha || '-' },
		{ header: 'Monto (Bs)', accessor: r => r.monto ? r.monto.toFixed(2) : '-' },
		...
		<div style={{ padding: '2rem', maxWidth: '1200px', margin: '0 auto' }}>
			...
			<div style={{ marginBottom: '2rem' }}>
				...
				<p style={{ 
					...
					Registro de multas del condominio
				</p>
			</div>
