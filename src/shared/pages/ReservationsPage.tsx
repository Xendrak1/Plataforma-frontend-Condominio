...
export function ReservationsPage() {
	...
	const { term, setTerm, filteredData } = useTableFilter(data, ['codigo', 'area_nombre', 'codigo_vivienda', 'persona_nombre', 'estado'])
	const [isCreateModalOpen, setIsCreateModalOpen] = useState(false)
	
	const columns: TableColumn<Row>[] = [
		{ header: 'Código', accessor: r => r.codigo },
		{ header: 'Área', accessor: r => r.area_nombre },
		{ header: 'Vivienda', accessor: r => r.codigo_vivienda },
		{ header: 'Fecha', accessor: r => r.fecha || '-' },
		{ header: 'Inicio', accessor: r => r.hora_inicio },
		{ header: 'Fin', accessor: r => r.hora_fin },
