...
import { useCreateCommunication } from '../../features/communications/hooks'
...
export function CreateCommunicationModal({ isOpen, onClose }: CreateCommunicationModalProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setFormData({ titulo: '', cuerpo: '', publico: 'TODOS' })
      onClose()
    } catch (error) {
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
            ...
            <div>
              ...
              >
                ...
                <option value="ADMINISTRACION">Solo administración</option>
              </select>
            </div>
